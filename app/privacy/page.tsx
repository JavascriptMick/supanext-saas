const PrivacyPage = () => {
  return (
    <div className="prose lg:prose-xl m-5">
      <h1>Privacy Statement</h1>

      <p>
        Your privacy is important to us. This privacy statement explains what
        personal data we collect from you and how we use it. By using our
        website, you agree to the terms of this privacy statement.
      </p>
      ...
      <p>
        ...
        credentials. For more information about Supabase&apos;s data practices,
      ...
      <p>
        ...
        services you request, to communicate with you, and to improve our
        website. We may also use your information for marketing purposes, but we
        will always give you the option to opt-out of receiving marketing
      ...
      <p>
        ...
        necessary to comply with the law or to protect our rights or the rights
        of others.
      </p>
      ...
      <p>
        ...
        information about Supabase&apos;s data sharing practices, please refer
