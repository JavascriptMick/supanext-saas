const TermsPage = () => {
  return (
    <div className="prose lg:prose-xl m-5">
      ...
      <p>
        These terms of service (the &quot;Agreement&quot;) govern your use of
        our website and services (collectively, the &quot;Service&quot;). By
        using the Service, you agree to be bound by the terms of this Agreement.
      ...
      <ul>
        ...
        <li>
          ...
          by us, may harm us or users of the Service or expose them to liability
        </li>
      </ul>
      ...
      <p>
        ...
        available on an uninterrupted, secure, or error-free basis, or be free
      ...
      <p>
        ...
        any claims, liabilities, damages, judgments, fines, costs, and expenses.
      </p>
    </div>
  );
};
